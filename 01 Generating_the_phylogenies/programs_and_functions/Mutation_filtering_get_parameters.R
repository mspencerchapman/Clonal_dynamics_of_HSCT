...
cran_packages=c("seqinr","stringr","optparse","parallel")
...
root_dir="~"
source(paste0(root_dir,"/Generating_the_phylogenies/foetal.filters.parallel.R")) #This should be point to whereever this script is saved
...
min_sample_mean_cov = opt$c #Mean coverage cut-off to include samples in analysis (mean coverage calculated from loci in bed-file only)

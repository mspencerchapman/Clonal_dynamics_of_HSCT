...
all.trees.adj1=Map(exp_no=exp_nos,remove_samples=remove_samples_list,f=function(exp_no,remove_samples) {
...
sigs<-dplyr::bind_rows(Map(tree=all.trees,Individual=names(all.trees),f=function(tree,Individual) {
...
#Save files
saveRDS(tree_lists,file=paste0(root_dir,"/data/tree_lists.Rds"))
saveRDS(details_lists,file=paste0(root_dir,"/data/details_lists.Rds"))
saveRDS(sample_metadata,file=paste0(root_dir,"/data/sample_metadata_full.Rds"))

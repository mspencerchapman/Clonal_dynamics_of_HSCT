...
param_posterior<-read.delim("/lustre/scratch119/casm/team154pc/ms56/Zur_HSCT/ABC_models/ABC_Apr2022/posterior_sample.txt")
...
output_dir="/lustre/scratch119/casm/team154pc/ms56/Zur_HSCT/ABC_models/ABC_Age/output"

...
param_posterior<-read.delim(paste0(root_dir,"/data/posterior_sample.txt"))
these_params=colnames(param_posterior)
HSC_pop_posteriors<-read.delim(paste0(root_dir,"/data/KX001_KX002_combined_Nt_posterior.txt"),header = F)%>%

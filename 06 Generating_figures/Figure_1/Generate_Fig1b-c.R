...
pdf(paste0(plots_dir,"Fig1b.pdf"),width = 12,4)
Pair_new="Pair_4" #Pair_4 is used as the example in the manuscript, but this can be changed to any of the pairs
par(mfrow=c(1,2))
...
pdf(paste0(plots_dir,"Fig1c.pdf"),width = 8,4)
Pair_new="Pair_4" #Pair_4 is used as the example in the manuscript, but this can be changed to any of the pairs
